		...
		<div class="container-fluid">
			<div class="row">
				...
				<div class="col">
					  	...
					  	<form class="row g-3 " action="./list" method="get" id="searchForm">
							<div class="col-auto ml-auto">
								<div class="input-group">
									...
									<div style="margin-right: 5px; padding: 5px;">
									...
									<div class="form-group">
										<div class="input-group input-group-lg">
											<input type="text" class="form-control form-control-lg" placeholder="검색어를 입력하세요." id="search" name="search" value="${pagination.search}">
								...
								<div class="input-group">
									...
									<div class="form-group">
										<div class="input-group input-group-lg">
											<input type="text" class="form-control form-control-lg" placeholder="검색어를 입력하세요." id="search" name="search" value="${pagination.search}">
											<div class="input-group-append">
												<button type="submit" class="btn btn-lg btn-default lectureSearch" id="submit">
													<i class="fa fa-search"></i>
												</button>
											</div>
										</div>
					...
					<div class="invoice">
								...
								<table class="table table-hover text-nowrap" data-board-name="${board}">
									...
									<c:if test="${board eq 'lectureNotice'}">
										<tr class="check-item">
											...
											<td>${dto.regDate}</td>
											<td><fmt:formatDate value="${dto.modifyDate}" pattern="yyyy-MM-dd" /></td>
											<td>${dto.hit}</td>
										</tr>
									</c:if>
						...
						<div class="col-12 float-right" style="margin-bottom: 20px; margin-right: 10px;">
							<c:if test="${board eq 'notice'}">
								<sec:authorize access="hasRole('ROLE_ADMIN')">
			...
			<div class="row">
				<c:if test="${board eq 'qna' || board eq 'notice'}">
					...
					<c:if test="${board eq 'lectureQna' || board eq 'lectureNotice'}">	
						<div class="row lectureNums" style="margin: 20px auto;" data-lectureNum-id="${pagination.lectureNum}">
							<ul class="pagination" style="width: 200px;">
								<c:if test="${pagination.pre}">
									<li class="page-item">
